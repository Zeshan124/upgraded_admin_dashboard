...
const CreateCoupon = ({
  ...
  } = useProducts(initialProduct);
  const {
    categoryData,
    categoryError: errorcategory,
    categoryLoading: isLoadingcategory,
  } = useCategories(initialCategory);
  ...
  const typeOptions = [
    { value: "Fixed Amount", id: "1" },
    { value: "Percentage Amount", id: "0" },
  ];
  ...
  const onSubmit = async (data) => {
    const formattedStartDate =
      data.startDate && data.startDate[0].format(dateFormat);
    const formattedExpiryDate =
      data.startDate && data.startDate[1].format(dateFormat);
    const formattedExpiryTime =
      data.expiryTime && data.expiryTime.format(Timeformat);
    const newData = {
      ...data,
                    ...
                    <div className="ps-block__content">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          type="text"
                          placeholder="Enter couponCode name..."
                        />
                        {errors.couponCode && (
                      ...
                      <div className="form-group ">
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Select
                              {...field}
                              placeholder="click to select appliedTo"
                              size="large"
                              className="w-100"
                      ...
                      <div className="form-group ">
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Select
                              {...field}
                              placeholder="click to Type Of Plan"
                              size="large"
                              className="w-100"
                              onChange={(value) => field.onChange(value)}
                  ...
                  <figure className="ps-block--form-box">
                    ...
                    <div className="ps-block__content">
                      ...
                      <div className="form-group">
                        ...
                        <input
                          className="form-control"
                          {...register("maxSpend", { required: true })}
                          type="number"
                      ...
                      <div className="form-group">
                        ...
                        <input
                          className="form-control"
                          type="number"
                          {...register("limitused", { required: true })}
                          placeholder="Enter limitused..."
                        />
                        {errors.limitused && (
                          <span className="text-danger">Required Field</span>
                        )}
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Select
                              {...field}
                              mode="multiple"
                              placeholder="click to select productInclude"
                              size="large"
                              className="w-100"
                              onChange={(value) => field.onChange(value)}
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Select
                              {...field}
                              mode="multiple"
                              placeholder="click to Exclude Product"
                              size="large"
                              className="w-100"
                              onChange={(value) => field.onChange(value)}
                              options={productData?.map((item) => ({
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Select
                              {...field}
                              mode="multiple"
                              placeholder="click category Include"
                              size="large"
                              className="w-100"
                              onChange={(value) => field.onChange(value)}
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Select
                              {...field}
                              mode="multiple"
                              placeholder="click categoryExclude"
                              size="large"
                              className="w-100"
                              onChange={(value) => field.onChange(value)}
                              options={categoryData?.map((item) => ({
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Select
                              {...field}
                              mode="multiple"
                              placeholder="click to select planInclude"
                              size="large"
                              className="w-100"
                              onChange={(value) => field.onChange(value)}
                              options={plansOptions.map((number) => ({
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Select
                              {...field}
                              mode="multiple"
                              placeholder="click to Plan Exclude"
                              size="large"
                              className="w-100"
                              onChange={(value) => field.onChange(value)}
                              options={plansOptions.map((number) => ({
